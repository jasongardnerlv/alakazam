 ...
 */
public class AlakazamAppRule<C extends Configuration> implements TestRule {
    ...
    public AlakazamAppRule(Class<? extends Application<C>> applicationClass,
                             String configPath,
        ...
        try {
            ...
            final Bootstrap<C> bootstrap = new Bootstrap<C>(application) {
                ...
                public void run(C configuration, Environment environment) throws Exception {
                    ...
                    AlakazamAppRule.this.configuration = configuration;
                    AlakazamAppRule.this.environment = environment;
