package io.alakazam.auth.basic;
...
import io.alakazam.auth.Auth;
import io.alakazam.auth.AuthenticationException;
import io.alakazam.auth.Authenticator;
...
public class BasicAuthProviderTest extends JerseyTest {
    ...
    protected AppDescriptor configure() {
        final AlakazamResourceConfig config = AlakazamResourceConfig.forTesting(new MetricRegistry());
