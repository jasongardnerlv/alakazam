...
import io.alakazam.jersey.caching.CacheControlledResourceMethodDispatchAdapter;
import io.alakazam.jersey.errors.LoggingExceptionMapper;
import io.alakazam.jersey.guava.OptionalQueryParamInjectableProvider;
import io.alakazam.jersey.guava.OptionalResourceMethodDispatchAdapter;
import io.alakazam.jersey.jackson.JsonProcessingExceptionMapper;
import io.alakazam.jersey.validation.ConstraintViolationExceptionMapper;
...
public class AlakazamResourceConfig extends ScanningResourceConfig {
    private static final String NEWLINE = String.format("%n");
    private static final Logger LOGGER = LoggerFactory.getLogger(AlakazamResourceConfig.class);
    private String urlPattern;

    public static AlakazamResourceConfig forTesting(MetricRegistry metricRegistry) {
        return new AlakazamResourceConfig(true, metricRegistry);
    }

    public AlakazamResourceConfig(MetricRegistry metricRegistry) {
        this(false, metricRegistry);
    }

    private AlakazamResourceConfig(boolean testOnly, MetricRegistry metricRegistry) {
        super();
        urlPattern = "/*";
